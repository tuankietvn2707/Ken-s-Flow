      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 w-80 sm:w-96 glass-panel rounded-2xl shadow-2xl border border-theme overflow-hidden flex flex-col"
          ...
          >
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-theme-section custom-scrollbar">
              {messages.map(msg => (
                <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[80%] p-3 rounded-2xl text-sm whitespace-pre-wrap ${
                    msg.sender === 'user' 
                      ? 'bg-blue-500 text-white rounded-br-sm' 
                      : 'glass-panel border border-theme rounded-bl-sm shadow-sm'
                  }`}>
                    {msg.sender === 'ai' ? (
                      msg.isTyping ? (
                        <TypingMessage 
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="glass-panel border border-theme p-3 rounded-2xl rounded-bl-sm shadow-sm flex gap-1">
            ...
            {/* Quick Actions */}
            <div className="px-4 py-2 glass-panel border-t border-theme flex gap-2 overflow-x-auto custom-scrollbar">
            ...
            {/* Input */}
            <div className="p-3 glass-panel border-t border-theme">
              <form onSubmit={(e) => { e.preventDefault(); handleSend(); }} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-theme-section rounded-full text-sm outline-none focus:ring-2 focus:ring-cyan-500 transition-all"
                />
                <button 
                  type="submit" 
