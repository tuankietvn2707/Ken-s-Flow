  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 p-4 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-xl hover:shadow-cyan-500/30 hover:scale-105 transition-all z-40 group"
      >
